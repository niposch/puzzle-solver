...
class EdgeButton(QPushButton):
    def __init__(self, edge: EdgePosition, owner: "BlackBoxEditor") -> None:
        super().__init__("")
        self.edge = edge
        self.owner = owner
...
class BlackBoxEditor(QWidget):
    def __init__(self) -> None:
        ...
        intro = QLabel(
            "Click the perimeter to cycle through blank, H, R, and paired numbers. Right-click steps backward."
        )
